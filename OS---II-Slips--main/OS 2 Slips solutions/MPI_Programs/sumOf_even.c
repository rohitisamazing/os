// Write an MPI program to calculate sum of all even randomly generated 1000 numbers
...
//     // Each process calculates sum of even numbers in its portion of the array
